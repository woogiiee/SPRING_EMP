...
<body>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											...
											<img class="features_img" src="${pageContext.request.contextPath}/resources/images/home/product${dto.photo }.jpg"alt=""/>
											<h2>${dto.sal}</h2>
											<p>${dto.ename}</p>
   ...
   <!--   <script type="text/javascript">
    --><!--   $(function(){
    	$('.features_img').each(index,item){
    		var imgUrl='/resources/images/home/product'+ Math.floor(Math.random()*6+1)+'.jpg';
    		console.log(imgUrl);
